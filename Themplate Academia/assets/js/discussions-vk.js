jQuery(document).ready(function ($) {
  ...
  var group_id = '121607622'; // вписать id вашей группы
  var topic_id = '35050219'; // вписать id поста
  var quantityComments = 3; // количество комментариев для вывода

  $.ajax({
      url: 'https://api.vk.com/method/board.getComments?group_id=121607622&topic_id=35050219&count=10&extended=1&need_likes=1&sort=desc&v=5.4',
      dataType: "jsonp",
      success: function (responce) {
          ...
          showDiscussion(responce.response);

          $('.comment__text-title', '#reviews').mCustomScrollbar({
              setHeight: 130
          });
      }
  });
